...
#Plot data
ggplot(data=Population_variations_2010_2015, aes(x=DepCode, y=Variation, fill=DepCode)) + ylab("Average variation per year (%)") + xlab("Department code") + geom_bar(stat='identity', position='identity',show.legend = FALSE)
...
ggplot(data=most_attractives, aes(x=reorder(DepCode, -Variation), y=Variation, fill=DepName)) + ylab("Average variation per year (%)") + xlab("Department code") + geom_col(position = 'dodge')
...
ggplot(data=less_attractives, aes(x=reorder(DepCode, Variation), y=Variation, fill=DepName)) + ylab("Average variation per year (%)") + xlab("Department code") + geom_col(position = 'dodge')
